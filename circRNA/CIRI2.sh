...
WORKDIR="/home/lulunots/Documents/1_ncRNA/6_analysis/CIRI2/Grouped"
THREADS="6"

for platenr in 195 197 199 200 202; do
    for GROUP in lagging control; do
        # Define file paths
        INPUT="/home/lulunots/Documents/1_ncRNA/7_alignment/bwa/${platenr}_${GROUP}/.sam"
        OUTPUT="${WORKDIR}_v2/${platenr}_${GROUP}"
